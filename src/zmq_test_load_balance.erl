...
ok = erlzmq:send(Worker, <<"3">>, [sndmore]),
...
erlzmq:send(Frontend, <<"4">>, [sndmore]),
...
ok = erlzmq:send(Backend, <<"1">>, [sndmore]),
ok = erlzmq:send(Backend, ClientAddr, [sndmore]),
ok = erlzmq:send(Backend, <<"2">>, [sndmore]),
